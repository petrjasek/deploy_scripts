...
cat >"$APP"_"$DEVELOPER"_"$BRANCH" <<EOF
<VirtualHost *:80>
      DocumentRoot $INSTALL_DIR
      ServerName $BRANCH.$DEVELOPER.$APP.newscoop-test.sourcefabric.org
      ServerAlias www.$BRANCH.$DEVELOPER.$APP.newscoop-test.sourcefabric.org
